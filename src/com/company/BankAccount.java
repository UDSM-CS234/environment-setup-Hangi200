...
class BankPrep {
    ...
    void withdraw(double withdraw_amount){
        ...
        if(withdraw_amount <= accBalance){
            ...
            System.out.println("WITHDRAWAL SUCCESSFULL : Your current Balance is "+BankPrep.accBalance);
        }
        else {
...
public class BankAccount {
    ...
    public static void main(String[] args) {
        ...
        BankPrep acc1 = new BankPrep("stella",1234569015);
        BankPrep acc2 = new BankPrep("Hang",78901213);
